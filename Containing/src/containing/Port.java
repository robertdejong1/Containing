...
public class Port implements Serializable
{
    ...
    public Port() 
    {
        ...
        waypointList.add(new Vector3f(103,5.5f,0));
        waypointList.add(new Vector3f(103,5.5f, 1562));
        waypointList.add(new Vector3f(717,5.5f, 1562));
        waypointList.add(new Vector3f(717, 5.5f, 0));
